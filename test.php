<?php
	...
	$r = new rcon("127.0.0.1",25567,"test"); // Remplacer l'ip, le port et le mot de passe par les votres
	...
	define( 'MQ_SERVER_PORT', 25566 ); // Remplacer le port par le votre
	define( 'MQ_TIMEOUT', 1 );
...
<body>
    ...
    <div class="container">
    	<div class="jumbotron">
			<h2>Minecraft Query PHP Class et RCON remote console class</h2>
			
			<p>Grâce à l'utilisation de ces deux class, nous pouvons recevoir des informations de notre serveur et 
				envoyer des commandes sans plugins.<br />
			La seule chose que vous aurez à faire, c'est activer query et rcon dans le fichier server.properties.
			</p>
